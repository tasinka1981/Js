...
//    */
  ...
  //     const getPriceTopping = arr => {
  //       return arr.reduce((acc, item) => acc + item, 0)
  //   };
  //       totalPrice = Hamburger.SIZES[this._size].price + Hamburger.STUFFINGS[this._stuffing].price + getPriceTopping(Hamburger.TOPPINGS[this._toppings].price);
  //       // console.log(getPriceTopping(Hamburger.TOPPINGS[this._toppings].price));
//   return totalPrice;
// }
...
calculatePrice() {
    ...
    for(let key of this._toppings) {  
      console.log(key);
      summTopping = summTopping + Hamburger.TOPPINGS[this._toppings[key]].price;
      
    }
    console.log(summTopping);
    totalPrice = Hamburger.SIZES[this._size].price + Hamburger.STUFFINGS[this._stuffing].price + summTopping;
    return totalPrice;
  };
...
//    */
  calculateCalories() {
    ...
    let summ = 0;
    for(let key of this._toppings) {  
      summ += Hamburger.TOPPINGS[this._toppings[key]].calories;
    }
    totalCalor = Hamburger.SIZES[this._size].calories + Hamburger.STUFFINGS[this._stuffing].calories + summ;
    return totalCalor;
  }
}
